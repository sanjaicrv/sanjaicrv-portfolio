...
const projects = [
  {
    id: "001",
    title: "FinTrack Pro — Personal Finance Platform",
    stack: "React.js · TypeScript · Spring Boot · MySQL · JWT · Docker",
    description: "Production-grade personal finance platform with JWT authentication, 15+ secured REST API endpoints, income/expense tracking, savings goals, and real-time analytics dashboards. Reduced MySQL query execution time by 40% via indexing and JOIN optimization.",
    links: { live: "https://fintrack-pro-fullstack.vercel.app/landing", code: "https://github.com/sanjaicrv/fintrack-pro-fullstack" },
    image: "/p1.png",
    cta: "Live Demo"
  },
  {
    id: "002",
    title: "Parking Lot Management System — LLD",
    stack: "Java · OOP · Design Patterns · Collections Framework",
    description: "Scalable low-level design system adhering to SOLID principles with Strategy + Factory + Singleton design patterns. Achieved O(1) slot allocation via HashMap-based index — 10× faster than O(n) scan, validated at 1,000+ simulated operations.",
    links: { live: "https://parking-lot-system-lld--727823tuit204.replit.app/", code: "https://github.com/sanjaicrv/ParkingLotSystem-LLD" },
    image: "/p2.png",
    cta: "Live Demo"
  },
  {
    id: "003",
    title: "AI-Powered Jewellery Defect Detection",
    stack: "Python · YOLOv8 · OpenCV · Roboflow · Computer Vision",
    description: "Industrial AI inspection system for automated detection of jewellery defects using YOLOv8 and Computer Vision. Completed data pipeline with Roboflow annotation, mosaic and HSV augmentation. Building real-time inference with bounding box visualization targeting 60%+ reduction in manual inspection effort.",
    links: { live: "https://github.com/naveenrajnr16/Jewellery-Defect-Detection", code: "https://github.com/naveenrajnr16/Jewellery-Defect-Detection" },
    image: "/p3.png",
    cta: "GitHub Repo"
  },
  {
    ...
    stack: "React.js · Vite · TypeScript",
    description: "Responsive tourism website showcasing 20+ locations with dynamic content and smooth navigation. Implemented modular design with reusable components for faster scalability and a seamless user experience.",
    links: { live: "https://sanjaicrv.github.io/wanderLust/", code: "https://github.com/sanjaicrv" },
    image: "/p4.png",
    cta: "Live Demo"
  },
];
...
const ScrollStackCard = ({ project, index }: ScrollStackCardProps) => {
  return (
    <StarBorder
      ...
      color="#ffffff, #333333, #cccccc, #555555"
      speed="8s"
    >
      <div className="card-top-row">
        ...
        <StarBorder
          ...
          color="#ffffff, #444444, #aaaaaa, #666666"
          speed="3s"
        >
          {project.cta}
        </StarBorder>
